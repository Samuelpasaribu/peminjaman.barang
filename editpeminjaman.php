        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Edit Barang</h1>
              ...
              <section class="row">
                ...
                <?php
                  $id = $_GET['id'];
                  $query = mysql_query("SELECT * FROM peminjaman where id='$id'");
                  ...
                  <div class ="form-group">
                    ...
                    <input type="text"  value="<?php echo$qu['id_brg'] ?>" name="nama_barang" 
                    class="form-control" placeholder="" required>
                    </div>
                   <div class ="form-group">
                    <label for="exampleInputPassword1">Nama Peminjam</label>
                    <input type="text"  value="<?php echo$qu['id_peminjam'] ?>" name="nama_peminjam" 
                    class="form-control" placeholder="" required>
                    </div>
                     <div class ="form-group">
