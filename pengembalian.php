          ...
          <h2 class="page-header">Pengembalian</h2>
              <table id="tabelpengembalian" class="table table-bordered table-hover">
                     <thead>
                      ...
                      <?php
                     $sql = "select barang.id_brg, peminjaman.id_peminjaman, barang.nama_brg, peminjam.nama, peminjaman.tgl_pinjam, pengembalian.tgl_kembali from peminjaman join barang on peminjaman.id_brg=barang.id_brg join peminjam on peminjam.id_peminjam=peminjaman.id_peminjam  join pengembalian";
                      ...
                      ?>
                       <tbody>
                        <tr>
                          ...
                          <td> <a href="editpengembalian.php?id_pengembalian=<?php echo $lihat['id_brg']; ?>"
                           class="btn btn-danger">Edit</a>
                          <a href="hapuspengembalian.php?id=<?php echo $lihat['id_brg']; ?>"
